...
class XADataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        self.image_dir = os.path.join(self.root, 'images_xa_2020')
        self.label_dir = os.path.join(self.root, 'labels_xa_2020')
    ...
    def _load_data(self, index):
        ...
        label_path = os.path.join(self.label_dir, image_id[:-4] + '.png')
...
class XA3channels(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1,
        ...
        super(XA3channels, self).__init__(self.dataset, batch_size, shuffle, num_workers, val_split)