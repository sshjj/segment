...
#     w, h = image.size
#     image_file = os.path.basename(image_file).split('.jpg')[0]
...
#     assert dataset_type in ['VOC', 'COCO', 'CityScapes', 'ADE20K', 'CD']
...
#         os.makedirs('outputs')
#
#     # set the image files and predict
...
#     parser.add_argument('-c', '--config', default='CD', type=str,
